...
/// A thread-safe array.
public class SynchronizedArray2<Element> {
    fileprivate let queue = DispatchQueue(label: "SynchronizedArray2Access", attributes: .concurrent)
    fileprivate var array = [Element]()
}
 
// MARK: - Properties
public extension SynchronizedArray2 {
...
// MARK: - Equatable
public extension SynchronizedArray2 where Element: Equatable {
...
public extension SynchronizedArray2 {
    ...
    static func +=(left: inout SynchronizedArray2, right: Element) {
        left.append(right)
    }
