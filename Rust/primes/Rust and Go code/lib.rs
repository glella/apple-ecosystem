...
// Binding generator:               cbindgen src/lib.rs -l c > primeslib.h
...
// Optional functions to streamline is_prime do not bring any more code clarity
// fn limit(i: u32, n: u32) -> bool {
// 	i*i <= n
// }

// fn no_reminder(numeral: u32, divisor: u32) -> bool {
// 	numeral % divisor == 0
// }
